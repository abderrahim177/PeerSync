...
<body>
    ...
    <div id="name-modal" class="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-slate-900/40 dark:bg-black/75 backdrop-blur-sm opacity-0 pointer-events-none transition-opacity duration-300">
